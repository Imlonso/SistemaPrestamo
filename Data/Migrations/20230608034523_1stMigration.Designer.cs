...
namespace Data.Migrations
{
    ...
    [Migration("20230608034523_1stMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.EntityEquipo", b =>
                {
            ...
            modelBuilder.Entity("Entities.EntityMarca", b =>
                {
                    b.Property<int>("IdMarca")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entities.EntityPrestamo", b =>
                {
            ...
            modelBuilder.Entity("Entities.EntityEquipo", b =>
                {
                    b.HasOne("Entities.EntityMarca", "Marca")
                        .WithMany("Equipo")
                        .HasForeignKey("IdMarca")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Entities.EntityPrestamo", "Prestamo")
                        .WithMany()
